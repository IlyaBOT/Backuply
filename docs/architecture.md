...
Дата анализа: 8 сентября 2026 года. Это проект архитектуры; перечисленные ниже
возможности не реализованы в текущем приложении. Числовые параметры — стартовые
гипотезы для измерений, а не результаты бенчмарков.
